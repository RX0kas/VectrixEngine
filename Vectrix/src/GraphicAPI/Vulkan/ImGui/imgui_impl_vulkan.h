...
IMGUI_IMPL_API VkDescriptorSetLayout ImGui_ImplVulkan_GetTextureDescriptorSetLayout();
IMGUI_IMPL_API void             ImGui_ImplVulkan_WriteTextureDescriptor(VkDescriptorSet descriptor_set, VkSampler sampler, VkImageView image_view, VkImageLayout image_layout);
